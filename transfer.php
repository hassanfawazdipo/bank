    ...
    <div class="container">
        ...
        <form method="POST" action="process_withdrawal.php">
            ...
            <div class="form-group">
                ...
                <input type="number" id="amount" name="amount" placeholder="Enter Withdrawal amount" min="0.01" step="0.01" required>
            </div>
            <div class="form-group">
            <label for="payment_method">Payment Method:</label>
                <input type="text" id="amount" name="payment_method" value="Bank Withdrawal" readonly min="0.01" step="0.01" required>
            </div>
